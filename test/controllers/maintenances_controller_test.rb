...
class MaintenancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maintenance" do
    assert_difference('Maintenance.count') do
      post maintenances_url, params: { maintenance: { cost: @maintenance.cost, date: @maintenance.date, description: @maintenance.description, mileage: @maintenance.mileage, type: @maintenance.type, vehicle_id: @maintenance.vehicle_id, warranty: @maintenance.warranty, warranty_status: @maintenance.warranty_status } }
    end
  ...
  test "should update maintenance" do
    patch maintenance_url(@maintenance), params: { maintenance: { cost: @maintenance.cost, date: @maintenance.date, description: @maintenance.description, mileage: @maintenance.mileage, type: @maintenance.type, vehicle_id: @maintenance.vehicle_id, warranty: @maintenance.warranty, warranty_status: @maintenance.warranty_status } }
